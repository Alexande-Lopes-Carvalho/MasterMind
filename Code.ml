...
module Code :
  sig
    ...
    val wellplacedMotif  : string
    (* motif pour affichage console de pion mal placé *)

    val misplacedMotif : string
    ...
    (* affiche une liste de code*)
    val printListCode : t list -> unit
    ...
    struct
      ...
      let string_of_pion a =
        ...
        (fill (List.nth pionColor v) (*^ " "*)) ^ (String.make 1 (List.nth pionToken v)) ^ (fill defaultColor)
      ;;
...
Code.printListCode [Code.makeCode"aaba"; Code.makeCode"aaba"; Code.makeCode"aaba"; Code.makeCode"aaba"; Code.makeCode"aaba"];
